...
wellspec_dict["GRID"] = (
    ...
    None,
    False,
)  # or use main grid name as default
wellspec_dict["RADW"] = (
    0,
    wk_preferred,
    wk_required,
    0.25,
    True,
)  # use pagoda spec value for i.p. perf
...
wellspec_dict["ANGLV"] = (
    ...
    0.0,
    False,
)  # default for other perfs (vertical)
wellspec_dict["LENGTH"] = (
    0,
    wk_okay,
    wk_okay,
    None,
    True,
)  # derive default from cell size
wellspec_dict["KH"] = (
    0,
    wk_okay,
    wk_okay,
    None,
    True,
)  # althernative to LENGTH (one required)
...
wellspec_dict["IRELPM"] = (
    0,
    wk_okay,
    wk_okay,
    None,
    False,
)  # default fracture IRELPM for i.p. perf
wellspec_dict["RADB"] = (
    0,
    wk_okay,
    wk_okay,
    None,
    True,
)  # calculate from cell size & k_align, k_v
wellspec_dict["WI"] = (
    0,
    wk_okay,
    wk_okay,
...
wellspec_dict["K"] = (
    ...
    None,
    False,
)  # derive from conductivity for i.p. perf?
wellspec_dict["LAYER"] = (
    0,
    wk_preferably_not,
    wk_okay,
    None,
    False,
)  # use LGR i.p. layer for i.p. perf
wellspec_dict["DEPTH"] = (
    0,
    wk_okay,
    wk_okay,
    "#",
    True,
)  # # causes nexus to use cell depth
...
wellspec_dict["CELL"] = (
    ...
    None,
    False,
)  # CELL is for unstructured grids
wellspec_dict["DTOP"] = (
    0,
    wk_banned,
    wk_banned,
    None,
    True,
)  # not compatible with ANGLA, ANGLV
wellspec_dict["DBOT"] = (
    0,
    wk_banned,
    wk_banned,
...
wellspec_dict["RADWP"] = (
    ...
    None,
    True,
)  # use pagoda wellbore radius
wellspec_dict["PORTYPE"] = (
    0,
    wk_banned,
    wk_banned,
    None,
    False,
)  # dual porosity: todo: need to check values
wellspec_dict["FM"] = (
    0,
    wk_preferably_not,
    wk_okay,
    0.0,
    False,
)  # dual porosity: connection to fracture?
...
wellspec_dict["DZ"] = (
    ...
    None,
    True,
)  # non D'Arcy flow; use LENGTH value? or DZ
        ...
        while True:
            ...
            while True:
                ...
                if selecting:
                    ...
                    for column, v in zip(
                        columns_present, words[: len(columns_present)]
                    ):
                        if v == "NA":
                            row_dict[column] = np.NaN
                        elif v == "#":
